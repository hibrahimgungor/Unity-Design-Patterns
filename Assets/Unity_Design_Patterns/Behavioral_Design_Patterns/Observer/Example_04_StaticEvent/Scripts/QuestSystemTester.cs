...
namespace Unity_Design_Patterns.Behavioral_Design_Patterns.Observer.Example_04_StaticEvent
{
    ...
    /// Attach one tester per QuestSystem GameObject and assign the reference.
    /// Add two QuestSystem GameObjects to observe the static event problem —
    /// triggering one will notify all observers regardless of which instance fired.
    ///
    /// Space — StartQuest
    /// C     — CompleteQuest
    /// F     — FailQuest
