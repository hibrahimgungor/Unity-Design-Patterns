...
{
    /// <summary>
    /// Marker interface for all event types used with BaseEventChannelSO.
    ///
    ...
    ///    BaseEventChannelSO&lt;T&gt; requires where T : struct, IEvent. Without IEvent, any
    ///    struct could be passed as an event type, making misuse invisible at the call site.
    ///
