...
{
    /// <summary>
    /// Concrete event listener for channels that carry a single integer value.
    ///
    /// Attach this component to any GameObject that needs to react to an
    /// IntEventChannelSO. Assign the channel asset and wire up the UnityEvent
    /// in the Inspector — no subscription code required.
    /// </summary>
    public class IntEventListener : BaseEventListenerSO<int> { }
}
